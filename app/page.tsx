      ...
      <section id="pricing" style={{background:'#0F0F2A',padding:'88px 56px'}}>
        <div style={{maxWidth:1060,margin:'0 auto',textAlign:'center'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10,textAlign:'left',alignItems:'stretch'}}>
            {[
              {tier:'Gratuit',price:'0€',period:'pour toujours',featured:false,duo:false,items:['Modules 1 et 2 complets','Quiz et scénarios de base','Streak et XP'],locked:['Modules 3 à 6','Boussole portefeuille'],btn:'Gratuit',href:'/signup'},
              {tier:'Premium',price:'7,99€',period:'par mois · sans engagement',featured:true,duo:false,popular:true,items:['Tous les modules (6)','Boussole sur ton vrai compte','Journal de bord investisseur','Alertes résultats personnalisées','Certificat Investisseur Veltis'],locked:[],btn:'Premium',href:'/signup'},
              {tier:'Duo Famille',price:'11,99€',period:'par mois · 2 comptes',featured:false,duo:true,items:['Premium pour 2 comptes','Tableau de bord commun','Module « Investir en couple »','Boussole consolidée du foyer','Certificat Investisseur Veltis'],locked:[],btn:'Duo Famille',href:'/signup'},
              {tier:'Pro',price:'14,99€',period:'par mois · sans engagement',featured:false,duo:false,items:['Tous les modules (6)','Screener actions avancé','Rapport trimestriel IA','Webinaire mensuel live','Communauté Discord privée'],locked:[],btn:'Pro',href:'/signup'},
            ].map((p,i) => (
